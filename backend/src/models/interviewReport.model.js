    ...
    skillGap: {
      ...
      validate: {
        validator: function (v) {
          if (this.title === "Invalid Input") return true;
          return Array.isArray(v) && v.length > 0;
        },
        message: "Skill gap cannot be empty",
      },
    },
    technicalQuestions: {
      ...
      validate: {
        ...
        message: "Technical questions cannot be empty",
      },
    },
    behavioralQuestions: {
      ...
      validate: {
        ...
        message: "Behavioral questions cannot be empty",
      },
    },
    preparationPlan: {
      ...
      validate: {
        ...
        message: "Preparation plan cannot be empty",
      },
    },
    user: {
...
interviewReportSchema.pre("validate", function () {
  if (this.title === "Invalid Input") return;
